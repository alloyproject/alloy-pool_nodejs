...
function Coin(data){
    ...
    "dERokPan5wMCjQCCUTZQakNLqgDPQCnMfUdTH5fLWoBAg3JnU79jNkFarUVGqwJc6R5NW2qLE5iuocmSHgQWgHop1hv7nBsVYT",	//Stoks
    "dERoe9LX5jJjC7mjtJQ6QajHz59tH2NBXXgwgy3iPTuKdGuXJ1eKMTiUvmm8K7rgPfBmCkMqUUQdKhBz1BPQ3Dqw1TeyeBbVXZ"	//SX
    ]; // These are addresses that MUST have a paymentID to perform logins with.

    this.prefix = 823000;
    this.subPrefix = 42;
    this.intPrefix = 659160;

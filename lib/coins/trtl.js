...
function Coin(data){
    ...
    this.convertBlob = function(blobBuffer){
        return cnUtil.convert_blob(blobBuffer,2);
    };

    this.constructNewBlob = function(blockTemplate, NonceBuffer){
        return cnUtil.construct_block_blob(blockTemplate, NonceBuffer,2);
    };

    this.getBlockID = function(blockBuffer){
        return cnUtil.get_block_id(blockBuffer,2);
    };
    ...
    this.cryptoNight = function(convertedBlob) {
            return multiHashing.cryptonight_light(convertedBlob, 1);
    }

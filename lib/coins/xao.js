...
function Coin(data){
    ...
    this.coinDevAddress = "A76ZUVfffZwLYKaP9Yxii7H8YwbNp4qMxVBtjVeDKNsL6kzyasyacBv3vNsd84jMFJc1h2pRMPJrRNEXbhUa4otpC8oAnHV";  // Alex's XAO address
    this.poolDevAddress = "A76ZUVfffZwLYKaP9Yxii7H8YwbNp4qMxVBtjVeDKNsL6kzyasyacBv3vNsd84jMFJc1h2pRMPJrRNEXbhUa4otpC8oAnHV";  // Alex's XAO address
    ...
    this.getHeight = function(callback){
        global.support.rpcWallet('get_height', [], function (body) {
            console.log(body)
	    if (typeof(body) !== 'undefined' && body.hasOwnProperty('result')){
    ...
    this.cryptoNightAlloy = multiHashing['cryptonight-alloy'];

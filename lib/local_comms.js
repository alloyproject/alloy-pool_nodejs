        ...
        try{
            ...
            global.coinFuncs.getBlockHeaderByHeight(blockId, function(err, header){
                ...
                if (global.config.general.discordBlockAnnounce === true) {
                    ...
                    global.support.poolBotMsg("BLOCK " + blockId + " MINED! Reward: " + global.support.coinToDecimal(blockDataDecoded.value) + " " + global.config.general.coinCode + ", Effort: " + blockEffort + "%");
                }
                let txn = global.database.env.beginTxn();

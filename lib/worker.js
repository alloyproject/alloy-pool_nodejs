                ...
                ['pplns', 'pps', 'solo', 'prop', 'global'].forEach(function (key) {
                    ...
                    if (cachedData !== false) {
                        ...
                        if (cycleCount === 0) {
                            ...
                            var totalCachedHashes = cachedData.hashHistory.reduce(function(a, b) { return a.hs + b.hs; }, 0);
                            if (totalCachedHashes > 0) {
                                cachedData.hashRateAvg = Math.floor(totalCachedHashes / cachedData.hashHistory.length);
                            } else {
